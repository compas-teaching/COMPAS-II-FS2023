...
# own function
from zac_zhuo_zhang_texture import path_smooth
...
def main():
    ...
    slicer = PlanarSlicer(compas_mesh, slicer_type="cgal", layer_height=40)
    slicer.slice_model()
    ...
    ############################################################################
    path_smooth(slicer, smooth_distance=50)
